Public Class Supplier
    ...
    Private Sub DataGridView1_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellDoubleClick
        Try
            ...
            DataGridView2.DataSource = getDataTBDSet("*", "TbKontakSupplier", "IDSupplier=" & kodeSup)
    ...
    Sub setGV()
        ...
        DataGridView1.Columns(1).Width = temp * 0.2
        DataGridView1.Columns(2).Width = temp * 0.73

        DataGridView1.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.AllCells
        DataGridView1.Columns.Item(2).DefaultCellStyle.WrapMode = DataGridViewTriState.True
    End Sub
    ...
    Sub setGV_2()
        ...
        DataGridView2.Columns(2).Width = temp * 0.2
    End Sub
    ...
    Sub reloaddset()
        ...
        DataGridView2.DataSource = getDataTBDSet("*", "TbKontakSupplier").Tables("result")
        setGV()
        setGV_2()
    End Sub
End Class