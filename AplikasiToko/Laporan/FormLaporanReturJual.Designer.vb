...
Partial Class FormLaporanReturJual
    ...
    Private Sub InitializeComponent()
        ...
        Me.GroupBox1.Text = "Opsi Pilihan Pengecekan Laporan Retur Jual"
        '
        'DateTimePicker3
        '
        ...
        Me.RadioButton1.Text = "Seluruh Retur"
        Me.RadioButton1.UseVisualStyleBackColor = True
        '
        'FormLaporanReturJual
        '
