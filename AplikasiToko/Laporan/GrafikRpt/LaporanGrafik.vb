...
Public Class LaporanGrafik
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AplikasiToko.LaporanGrafik.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanGrafik
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanGrafik = New LaporanGrafik()
        rpt.Site = Me.Site
        Return rpt
    End Function
