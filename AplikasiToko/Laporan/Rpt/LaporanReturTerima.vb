...
Public Class LaporanReturTerima
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AplikasiToko.LaporanReturTerima.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporanReturTerima
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LaporanReturTerima = New LaporanReturTerima()
        rpt.Site = Me.Site
        Return rpt
    End Function
